...
from ..utils import BATCH_PATTERN, EXTRA_COLUMNS, STOCK_RESULT_FILE, calc_expiry_info, get_product_code, parse_quantity
...
def enrich_excel(filepath: str, ref_date: datetime) -> tuple[pd.DataFrame, int]:
    ...
    df.to_excel(STOCK_RESULT_FILE, index=False, header=False)
